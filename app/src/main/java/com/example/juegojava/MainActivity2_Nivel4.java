...
public class MainActivity2_Nivel4 extends AppCompatActivity {
    ...
    ImageView iv_AUno, iv_ADos, iv_Vidas, signoOperacional;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 4: Ejercicios Mixtos", Toast.LENGTH_LONG).show();
        ...
        signoOperacional = findViewById(R.id.imageView_Signo);
    ...
    private void numAleatorio() {
        if(score <= 39){
            ...
            int resultadoTemp = numAleatorio_1 - numAleatorio_2;
            if(resultadoTemp >= 0){
                if(numAleatorio_1 > 0 && numAleatorio_2 <= 4){
                    signoOperacional.setImageResource(R.drawable.adicion);
                    ...
                    // Eliminar el FOR como prueba de mejora
                    for (int i = 0; i < numero.length; i++) {
                        signoOperacional.setImageResource(R.drawable.resta);
                        resultado  = numAleatorio_1 - numAleatorio_2;
                        int id = getResources().getIdentifier(numero[i], "drawable", getPackageName());
                        if (numAleatorio_1 == i) {
                            iv_AUno.setImageResource(id);
            ...
            Toast.makeText(this, "Lograste la maxima puntuacion!",Toast.LENGTH_LONG).show();
            Intent intent = new Intent(this,MainActivity.class);
